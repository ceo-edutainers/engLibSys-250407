...
import EndScreen from '@/components/readingSelfcourse/EndScreenA-For-Lesson'
...
function readingSelfCourseA() {
  ...
  const [courseName, setCourseName] = useState('CourseA') //self-CourseA, self-CourseB, self-CourseZ
  const [courseSelf, setCourseSelf] = useState('')
  const [thisSubject, setThisSubject] = useState('READING')
  ...
  return (
    <div className="AppBig">
      ...
      >
        {/* <h1>
          {' '}
          <b>practiceTempId:{practiceTempId}</b>
        </h1> */}
        {/* <div>
