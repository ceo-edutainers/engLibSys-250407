...
function lessonPre() {
  ...
  const [cN, setCN] = useState(query.courseName)
  ...
  const [yoyakuWeekday2, setYoyakuWeekday2] = useState()
  const [yoyakuDate2, setYoyakuDate2] = useState()
  const [yoyakuTime2, setYoyakuTime2] = useState()
  ...
  useEffect(() => {
    if (localStorage.getItem('loginStatus') == 'true') {
      if (router.isReady) {
        ...
        var cN = router.query.courseName
        // alert('cN' + router.query.courseName)
        const fetchData2 = async () => {
          try {
            var url = DB_CONN_URL + '/get-hw-test-first-page/'
            var Url = url + mbn + '&' + cN
            ...
            setYoyakuWeekday2(response.data[0].yoyakuWeekday)
            setYoyakuDate2(response.data[0].yoyakuDate)
            setYoyakuTime2(response.data[0].yoyakuTime)
      ...
      <div className="AppBig">
        ...
        <div className="row pt-3">
          <div className="col-lg-12 col-md-12 mt-3">
            ...
            <hr />
            <h2>
              {yoyakuWeekday2} | {yoyakuDate2} | {yoyakuTime2}〜
            </h2>
          </div>
        </div>
        <div
