    ...
    axios
      ...
      .then((response) => {
        if (!response.data.status) {
          ...
          var qrUrl =
            'https://www.myenglib.net/event-intro-reg?eID=' +
            eID +
            '&rfn=' +
            thisRfn
          setQrLinkUrl(qrUrl)
    ...
    <>
      <div className="AppBig">
        ...
        >
          ...
          <a
            className="btn btn-info mr-2 pt-0 pb-0"
            href="https://englib-materials.s3.ap-northeast-1.amazonaws.com/document/Payment-2024-2-ver2-2.pdf"
            target="_blank"
          >
            お月謝・教材費
          </a>
                ...
                >
                  ...
                  {qrLinkUrl && (
                    <QrcodeGeneratorForEvent
                      url={qrLinkUrl}
                      // url="https://www.myenglib.net/event-intro-reg?eID=9584rrf89&rfn=bea809b534edbb0d2df2"
                      title="友達紹介キャンペーン"
                      size="200"
                    />
                  )}
