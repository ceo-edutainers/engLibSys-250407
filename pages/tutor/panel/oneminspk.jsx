...
// import ViewOnemin from '@/components/Output_ShowAndTell/ViewOnemin'
...
const READINGA = () => {
  ...
  const [oneminView, setOneminView] = useState(false)
  ...
  return (
    <>
      ...
      >
        ...
        <div className="col-lg-4 col-md-12 text-left"></div>
      ...
      >
        ...
        >
          {oneminView && courseName == 'Course1MIN' && (
            <span
              className="btn btn-danger mr-2"
              onClick={() => {
                setOneminView(!oneminView)
                // handleClear()
              }}
            >
              1-Min Speaking
        ...
        {/* <div style={{ width: '100%', display: oneminView ? 'block' : 'none' }}>
          {course && courseName && (
            <ViewOnemin
              courseName={courseName}
              course={course}
