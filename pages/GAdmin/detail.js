...
// import DetailRankingPoint from '@/components/GAdmin/DetailRankingPoint'
// import DetailRankingMonster from '@/components/GAdmin/DetailRankingMonster'
import DetailCancelRate from '@/components/GAdmin/DetailCancelRate'
import DetailHowManyBook from '@/components/GAdmin/DetailHowManyBook'
import DetailReadingStudy from '@/components/GAdmin/DetailReadingStudy'
import DetailShadowingStudy from '@/components/GAdmin/DetailShadowingStudy'
...
// const [pageName, setPageName] = useState(query.pn)
// const [cbn, setCbn] = useState(query.cbn)

// useEffect(() => {
//   if (router.isReady) {
//     // Code using query
//     console.log('router.query', router.query)
//     setPageName(router.query.pn)
//     setCbn(router.query.cbn)
//   }
// }, [router.isReady])

const SingleCourses = ({ paegName }) => {
  return (
    <React.Fragment>
      <NavbarEnglib_GAdmin />
      <hr />
      <div className="row">
        <div className="col-lg-12 col-md-12">{/* <pageName /> */}</div>
      </div>
