...
import VoiceRecorder from '@/components/quizappSchoolEnglishTest/VoiceRecorder'
...
const Quiz = () => {
  ...
  let logOut = () => {
    ...
    Router.push('/loginSchoolEnglishLevelTest')
  }
  ...
  useEffect(() => {
    ...
    var Url =
      DB_CONN_URL +
      '/get-leveltest-quiz-for-school-english/' +
      quizTempId +
      '&' +
      mbn +
      '&' +
  ...
  if (isError) return <h1>Error, try again1!</h1>
