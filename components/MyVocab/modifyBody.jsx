...
const SingleCourses = () => {
  ...
  const [viewORT, setViewORT] = useState(false)
  const [viewRT, setViewRT] = useState(false)
  const [viewBC, setViewBC] = useState(false)
  // useEffect(() => {
  //   //Rapid API
  //   const options = {
  //     method: 'GET',
          ...
          <div className="col-lg-6 col-md-12 mt-0 pt-0">
            ...
            <div className="courses-details-desc-style-two">
              ...
              <div className="row">
                ...
                >
                  <span
                    ...
                    onClick={() => {
                      setViewORT(true), setViewRT(false), setViewBC(false)
                    }}
                  >
                    ORT
                  </span>
                  <span
                    className="btn btn-warning mr-2"
                    onClick={() => {
                      setViewORT(false), setViewRT(true), setViewBC(false)
                    }}
                  >
                    Reading Triumphs
                  </span>
                  <span
                    className="btn btn-warning mr-2"
                    onClick={() => {
                      setViewORT(false), setViewRT(false), setViewBC(true)
                    }}
                  >
                    BlackCat
                  </span>
              ...
              <div className="middleBody">
                <div
                  style={{ width: '100%', display: viewORT ? 'block' : 'none' }}
                >
                  ORT
                </div>
                <div
                  style={{ width: '100%', display: viewRT ? 'block' : 'none' }}
                >
                  RT
                </div>
                <div
                  style={{ width: '100%', display: viewBC ? 'block' : 'none' }}
                >
                  BC
                </div>
                ...
                <div className="courses-curriculum p-0">
                  ...
                  {selectedWords.map((val, key) => {
                    var imgurl =
                      // '/img_voca5000/'
                      `https://${PUBLIC_R2_DOMAIN}/img_voca5000/`
