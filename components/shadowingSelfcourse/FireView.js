...
import fireRed from './img/fire_shadowing.png'
  ...
  return (
    <div>
      ...
      <div
        ...
        aria-label="毎日続けてシャドーイングの練習すると(Step1からStep4の最後のステップまで終了する)、その日数がここに表示されます。1日でもできない日があった場合、この数字はリセットされます。7日達成毎にモンスターを一個ゲットできます。ゲットしたモンスターは色が変わります。"
