      ...
      <div className="QuizBigShadowing" style={{ backgroundColor: 'white' }}>
        <div className="container">
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-12 col-md-12 mb-3 mt-0 pb-0">
              <Subpage
          ...
          >
            ...
            10回以上聴いても聴き取れない部分がある場合は、右側のGive
            upボタンを押して、正しいセンテンスを確認し、もう一度音声を聞いて書いてみます。"
              data-balloon-pos="up"
              data-balloon-length="fit"
            ></p> */}
            {/* <p>{thisRightAnswerAru}</p> */}
            {SplitHWbookInfo.map((val, key) => {
              ...
              return (
                <>
                  <div className="row">
                    ...
                    {/* {thisRightAnswerAru[key] != ra ? ( */}
                    {/* {thisRightAnswerAru[key].filter((x) =>
                      String(x.thisRightAnswerAru[key]).includes('Right') */}
                    {/* {thisRightAnswerAru.includes(ra) ? ( */}
