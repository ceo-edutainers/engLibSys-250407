...
import IdiomListVideo from '@/components/readingSelfcourse/IdiomListVideo' //単語リスト
...
import WordListShadowingVideo from '@/components/shadowingSelfcourseVideo/WordListShadowingVideo' //単語リスト
...
import VoiceRecorderToS3ForSelfLessonVideoShadowing from '@/components/VoiceRecorder/VoiceRecorderToS3ForSelfLessonVideoShadowing2'
...
import StepImportantWords3 from '@/components/shadowingSelfcourseVideo/StepImportantWordsSHstep3'
...
const StepSH3 = () => {
  ...
  const [pageTitleSub, setPageTitleSub] = useState(
    '<ruby>音源<rt>おんげん</rt></ruby>を<ruby>聴<rt>き</rt></ruby>きながら<ruby>以下のビデオスクリプトを音読<rt>おんどく</rt></ruby>する'
  )
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        var url = DB_CONN_URL + '/get-hw-and-Shadowing-movie-script-by-time'
        // alert(youtubeID)
        axios
          .post(url, {
            youtubeID,
    ...
    <>
      ...
      <div className="QuizBigShadowing" style={{ backgroundColor: 'white' }}>
        <div className="container">
          ...
          <VoiceRecorderToS3ForSelfLessonVideoShadowing
            mbn={myMbn}
            homework_id={HWID}
            practiceTempId={practiceTempId}
            audioDurationFromDB={audioDuration}
            pointKeyNum={pointKeyNum}
          ...
          {/* <hr /> */}
          {/* <div
            className="col-lg-12 col-md-12 pt-2 mb-5　ml-1 mr-2"
            style={{
              textAlign: 'left',
          ...
          <div className="col-lg-12 col-md-12 mt-4 mb-3">
            ...
            <p style={{ color: 'red' }}>
              ...
              くしてプレイしてください。
              {/* 最後に一番下の「知らない単語を登録する」ボタンを押して、単語をチェックするのを忘れずに！ */}
            </p>
          </div>

          <div
            className="col-lg-12 col-md-12 mt-4 mb-5 p-5 ml-1 mr-2"
            style={{
              textAlign: 'left',
              border: '1px solid #dedede',
              borderRadius: '10px',
