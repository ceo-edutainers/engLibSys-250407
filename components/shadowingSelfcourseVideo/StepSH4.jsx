...
import StepImportantWords4 from '@/components/shadowingSelfcourseVideo/StepImportantWordsSHstep4'
...
const StepSH4 = () => {
  ...
  const handlePracticeRest = () => {
    ...
    hwHistoryUpdate('holding', HWID, practiceTempId, nextStep)
  }
  ...
  const nextStep = (option, arrayNum) => {
    ...
    //ここでpointを入れる
    // axios
    //   .post('https:///word-quiz5000-result-insert', {
    //     practiceTempId: practiceTempId,
    //     mbn: myMbn,
    ...
    <>
      ...
      <div className="QuizBigShadowing" style={{ backgroundColor: 'white' }}>
        <div className="container">
          ...
          <SweetAlert
            title="Step4が終わったら必ず「練習を終了する」ボタンを押してください。"
          ...
          >
            <p>
              Step4が終わってから、終了ボタンを押さないとファイヤーをゲットできませんので、ご注意ください。
            </p>
          </SweetAlert>
        </div>
      </div>
