...
import PointBar from '@/components/shadowingSelfcourseVideo/PointBarFirst'
...
import StepImportantWordsSHstep1 from '@/components/shadowingSelfcourseVideo/StepImportantWordsSHstep1'
              ...
              <div className="row">
                <div className="col-lg-12 col-md-12">
                  ...
                  <h6 style={{ fontSize: '15px' }}>
                    このステップ（ステップ1）は、一週間の課題を進める中で、練習1日目の最初の1回だけ行います。
                    <br />
                    このページからトップページに戻る方法はありませんので、最後まで進んでください。
                    <br />
                    ページをリロードするとログインページに戻ってしまうので、ご注意ください。
                  </h6>
                </div>
              </div>
            </>
