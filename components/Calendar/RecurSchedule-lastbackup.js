...
function RecurSchedule() {
  ...
  const tutorTimezone = () => {
    axios
      .post('http://localhost:3001/select-tutor-timezone', {
        email: t_email,
      })
      .then((response) => {
  ...
  const regTrySchedule = () => {
    axios
      .post('http://localhost:3001/reg-try-lesson-schedule', {
        name_eng: '',
      })
      .then((response) => {
  ...
  const regTutorSchedule = () => {
    ...
    axios
      .post('http://localhost:3001/reg-tutor-schedule', {
        dateList: dateList,
