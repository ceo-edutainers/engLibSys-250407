            ...
            return (
              <>
                ...
                <div className="questionsLineBig">
                  {/* <VoiceRecorder /> */}
                  <div>{/* <Stopwatch watchStatus={watchStatus} /> */}</div>
                  <div>
                    ...
                    >
                      {/* <span>
                        {listening
                          ? 'listening.........'
                          : currentAnswer != 'Right' &&
                            '再スタートするためには、「Restart」ボタンを押してください。'}
                      </span> */}
                    </span>
                    <br />
                    <span
                      className="btn btn-warning"
                      // onClick={() => speak({ text: val.yourLanguage })}
                    ></span>
                  </div>
                  {/* <div>{message}</div> */}
                  {/* <div>
                  ...
                  {rightTranscription !== '' && val.englishFull}
                  {/* <TextareaAutosize
                  ...
                  <p className="mt-3" style={{ color: '#414241' }}>
                    {giveup && val.english}
                  </p>
                </div>
