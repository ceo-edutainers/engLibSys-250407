...
const Quiz = () => {
  ...
  function handleClick(word) {
    ...
    //このwordがArrayに何個入っているか：実際には1個少なくカウントされるので最後に+1をする
    // const thisWordCount =
    //   oneClickWords.filter((name) => name == word + ' ').length + 1
                ...
                return (
                  <>
                    {/* <HtmlTooltip
                      title={
                        <>
                          <Typography color="inherit">意味:</Typography>
                    ...
                    <Tooltip
                      ...
                      title={
                        ...
                        >
                          ...
                          />
                          <br />
                          <span className="mr-2">{val.word}</span>
                          {/* <video
