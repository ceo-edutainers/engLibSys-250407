...
//import './mycalendarfromscratch.css'

export default class MyCalendarFromScratch extends React.Component {
  state = {
    dateContext: moment(),
    today: moment(),
  ...
  render() {
    ...
    return (
      <div className="calendar-container mb-5" style={{ width: '100%' }}>
        {/* <table className="calendar"> */}
        <table style={{ width: '100%' }}>
          <thead>
            <tr className="calendar-header" style={{ textAlign: 'center' }}>
              <td colSpan="2" style={{ paddingBottom: 5 }}>
                <a
              ...
              <td colSpan="3" style={{ paddingBottom: 5 }}>
