      ...
      try {
        await axios
          ...
          .then((response) => {
            ...
            // console.log('monsterItem:' , response.data.monsterItem)
            // console.log(
            //   'beforePracticeTempId:' , response.data.beforePracticeTempId
            // )
            // console.log('differenceDay:', response.data.differenceDay)
            // console.log('updateFireView:', response.data.updateFireView)

            // alert('status:' + response.data.status)
            // alert('message:' + response.data.message)
            // alert('monsterItem:' + response.data.monsterItem)
            ...
            // alert('stepStatus' + response.data.stepStatus)
            // alert('thisSubject' + response.data.thisSubject)
            // alert('homework_id' + response.data.homework_id)
            // alert('practiceTempId' + response.data.practiceTempId)
            // alert('bFireView:' + response.data.bFireView)
            // alert('updateFireViewSeven' + response.data.updateFireViewSeven)
