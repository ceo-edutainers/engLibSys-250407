...
const Step1 = () => {
  ...
  //   "①電子書籍<span className='btn btn-danger' style={{fontWeight:'900',color:'red',cursor:'pointer}}><a href='https://www.oxfordreadingclub.jp/my/bookshelf' target='_blank' ><img src='/images/orc-logo.png' width='200px'></a></span>にログインします。この画面の右に見える本のタイトルをORCで検索し、<img src='/images/orc-view.png' width='20px'>を押してそのストーリーが見える状態にする。"
  // )
