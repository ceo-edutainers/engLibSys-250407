  ...
  return (
    <>
        ...
        <div className="row">
          <div className="col-lg-12 col-md-12  ">
            ...
            >
              ...
              チャプター毎の問題(本によってはチャプターの最後または本の巻末にまとめてあります)は、ある程度ストーリー自体を理解できるようになったら本に直接解いてください。問題を解いた後は、間違えを必ず直し、その写真をとってアップロードしてください。
              <Upload
                // mbn={myMbn}
                // homework_id={HWID}
              ...
              />
              <b>注意事項：</b>
              巻末問題の課題はどのタイミングでもアップロードすることができますが、ステップ１から３までのリーディングの課題目標ポイント合計が100ポイントに達成していない場合、次のストーリーに行けません。
            </div>
      ...
      <SweetAlert
        ...
        style={{ width: '600px' }}
      >
        <p>このストーリーの学習を終わらせて、次のストーリーへ進みますか？</p>
      </SweetAlert>
      <CopyrightFooter />
    </>
  )
