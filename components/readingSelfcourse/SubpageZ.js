...
const Subpage = ({
  ...
  return (
    <>
      ...
      <div className="row">
        <div
          className="col-lg-9 col-md-12 mt-0 mb-3"
          style={{
        ...
        >
          <p
            ...
            dangerouslySetInnerHTML={{ __html: subpageTitle }}
          ></p>
          ...
          {secondOrder && (
            <span dangerouslySetInnerHTML={{ __html: secondOrder }}></span>
          )}
          {thirdOrder && (
        ...
        <div
          className="col-lg-3 col-md-12 mt-0 mb-3"
          style={{
            backgroundColor: '#ffe4e1',
            padding: '15px',
            color: 'black',
