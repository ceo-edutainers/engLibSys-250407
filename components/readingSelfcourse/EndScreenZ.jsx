...
const EndScreen = () => {
  ...
  const handleNextHwSet = () => {
    ...
    // const fetchData = async () => {
    //   try {
    var url = DB_CONN_URL + '/update-reading-ORT-self-new-hw'
    axios
      .post(url, {
      ...
      >
        ...
        <div className="row">
          <div className="col-lg-12 col-md-12  ">
            {/* levelOrder: {levelOrder}
            <br />
            lessonOrder: {lessonOrder}, <br />
            seriesName: {seriesName}, <br />
            bookTitle: {bookTitle}, <br />
            bookNum: {bookNum}, <br />
            storyNum: {storyNum}, <br />
            courseName: {courseName}, */}
            <h1
              className="mb-3"
            ...
            {firstLastRecording.map((val, key) => {
              var diff =
                parseInt(totalLastPoint) - parseInt(cutlinePointToNextStory)
