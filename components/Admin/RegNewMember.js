      ...
      <center>
        <div className="col-lg-12 col-md-12">
          ...
          >
            ...
            <p>すでに会員の場合無料体験は受けられません。</p>
            <hr />
            <p>
              レッスンを受ける方が、学生ではない大人の場合ここをクリック&nbsp;
            </p>
            <input
              type="checkbox"
              value="adult"
            ...
            <div>
              <select>
                {dataInfo.map((val, key) => {
                  return (
                    <>
                      <option value={val.autoid}>
                        {val.name_eng}/{val.status}
                      </option>
            ...
            <div className="col-lg-12 col-md-12  pb-5">
              <div className="contact-form">
                ...
                <div
                  ...
                  style={{ display: memberType ? 'block' : 'none' }}
                >
                  <label
                    style={{
                      fontSize: '14px',
                ...
                <div
                  // style={{
                  //   // textAlign: 'left',
                  //   display: memberType ? 'display' : 'none',
                  // }}
                  style={{
                    maxWidth: '450px',
                    textAlign: 'left',
                    display: memberType ? 'none' : 'block',
                  }}
                >
                  <p style={{ color: 'white', fontWeight: 'bold' }}>
                    大人の場合、学習履歴に以下の内容をご記入ください。
                  </p>
                  <p style={{ color: 'white', fontWeight: 'bold' }}>
                    ①文法、リスニング、リーディング、ライティングの４技能のうち、a.自分が一番得意としている技能.
                    &nbsp;b.自分が一番苦手だと思う技能。
                  </p>
                  <p style={{ color: 'white', fontWeight: 'bold' }}>
                    ②自分自身で思う現時点の英語習熟度を
                    &nbsp;&nbsp;a.中学1年生レベル、b.中学卒業レベル、c.高校生以上で記入してください。
                    <p style={{ color: 'white', fontWeight: 'bold' }}>
                      ③過去に英検やTOEICなどの公的検定を受験した方は、その結果とおよその受験年をご申告ください。
                    </p>
                  </p>
                  <p style={{ color: 'white', fontWeight: 'bold' }}>
                    ④英語学習をしたいと思ったきっかけ
