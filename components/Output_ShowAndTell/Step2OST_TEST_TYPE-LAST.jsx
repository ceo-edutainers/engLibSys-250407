    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (response.data.length > 0) {
          ...
          if (response.data[0].outline_body !== '') {
            setOutlineBody(response.data[0].outline_body.trim())
          }
          // alert(response.data[0].outline_body)
            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-12 col-md-12 mt-0 mb-3 pt-0 ">
                ...
                <div
                  ...
                  // name="outline_body"
                  onInput={(e) => {
                    setTestwriting(e.currentTarget.textContent)
                  }}

                  // onInput={(e) => {
                  //   setOutlineBody(e.currentTarget.textContent)
                  // }}
                  // onInput={(e) =>
                ...
                {outlineBody && (
                  <textarea
                    ...
                    // dangerouslySetInnerHTML={{ __html: viewTest }}
                  ></textarea>
                )}
                <div
