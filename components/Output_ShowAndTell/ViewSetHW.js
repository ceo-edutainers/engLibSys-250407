                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style={{ width: '33%' }}>
                            ...
                            {/* &nbsp; setSelectedShadowingHW :###
                            {selectedShadowingHW}
                            ### */}
                            {/* {selectedShadowingHW}
                            <br />
                            {shadowingLevel}/{shadowSeriesName}/
                            {shadowBookTitle}/{shadowBookNum}/{shadowStoryNum} */}
                            <select
                              disabled={checkedOneMoreShadowing && 'disabled'}
                              style={{ width: '50%' }}
                              onChange={(e) => {
                            ...
                            >
                              {shadowingBookListInfo?.map((val2, key2) => {
                                ...
                                // ) {
                                //   console.log('autoid: ', val2.autoid)
                                //   setSelectedShadowingHW(val2.autoid)
                                // }
                            ...
                            {/* <table className="table p-0 m-0">
                              <tr className="p-0 m-0">
                                ...
                                >
                                  ...
                                  dictation assignment on the Shadowing page
                                  when necessary.
                                </td>
                              </tr>
                            </table> */}
