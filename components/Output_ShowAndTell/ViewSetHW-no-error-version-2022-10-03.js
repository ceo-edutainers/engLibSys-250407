...
const ViewSetHW = ({
  ...
  function changeShadowingLevel(newShadowingLevel) {
    ...
    //       .post(Url, {
    //         mbn: mbn,
    //         courseLevel: newShadowingLevel,
    //       })
    //       .then((response) => {
    //         alert(newShadowingLevel)
    //         var sL = newShadowingLevel
    //         setNewShadowingLevel(sL)
    //         getShadowingInfo(sL)
    //       })
                ...
                <>
                  ...
                  >
                    <tbody>
                            ...
                            >
                              ...
                              >
                                ...
                                <option
                                  value="1m 30s"
                                  selected={
                                    dictationSecond == '1m 30s' && 'selected'
                                  }
                                >
                                  1分 30秒
                                </option>
                                ...
                                <option
                                  value="2m 30s"
                                  selected={
                                    dictationSecond == '2m 30s' && 'selected'
                                  }
                                >
                                  2分 30秒
                                </option>
                                ...
                                <option
                                  value="3m 30s"
                                  selected={
                                    dictationSecond == '3m 30s' && 'selected'
                                  }
                                >
                                  3分 30秒
                                </option>
                              ...
                              >
                                ...
                                Shadowingページで
                                <br /> */}
                                Change the speed of shadowing, length of
                                dictation assignment on the Shadowing page when
                                necessary.
                              </td>
                            </tr>
                          </table>
                          {/* <a href="#" target="_blank">
                            <span className="btn btn-secondary">Materials</span>
                          </a> */}
                        </td>
                      </tr>
                      <tr>
                        <td colSpan="2">
                          {/* checkedOneMoreShadowing:(false/true)
                          <br /> */}
                          <input
                            type="checkbox"
                            onClick={() => {
                          ...
                          >
                            ...
                            >
                              ...
                              <option value="振替によりレッスン日の間隔が短くなったため練習日数不足">
                                振替によりレッスン日の間隔が短くなったため練習日数不足(Not
                                enough days to practice due to the shorter time
                                span in between lessons after make-up lesson.)
                              </option>
                              <option value="旅行や学校行事などの特別な行事により練習できる日数不足">
                                旅行や学校行事などの特別な行事により練習できる日数不足(Not
                                enough days to practice due to a special event
                              ...
                              <option value="病気や緊急の事情により練習ができない状況だったため">
                                病気や緊急の事情により練習ができない状況だったため(Not
                                being able to practice due to sickness and other
                            ...
                            {/* <br />
                          setWhySameShadowingReasonDetail:
                          {whySameShadowingReasonDetail} */}
                            &nbsp;
                            <input
                              type="text"
                              onChange={(e) => {
                                setWhySameShadowingReasonDetail(e.target.value)
                              }}
                      ...
                      <tr>
                        <td scope="row">
                          {/* checkedSetShadowingLevel(false/true)
                          <br /> */}
                          <input
                            type="checkbox"
                            onClick={() => {
                          ...
                          >
                            <select
                              ...
                              onChange={(e) => {
                                ...
                                getFirstAutoidByShadowingLevel(e.target.value)
                              }}
                            >
                              {' '}
                              <option>===Level Change===</option>
                        ...
                        <td style={{ width: '33%' }}>
                          ...
                          >
                            ...
                            <option
                              value="first half"
                              selected={
                                shadowingHWAmount == 'first half' && 'selected'
                              }
                            >
                              前半[first half]
                            </option>
                            <option
                              value="second half"
                              selected={
                                shadowingHWAmount == 'second half' && 'selected'
                              }
                            >
                              後半[second half]
                            </option>
